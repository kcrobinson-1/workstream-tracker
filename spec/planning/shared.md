...
slugs are server-generated: the agent supplies the parent context and
node-type, and the server picks the next available position number
and returns the constructed slug.
